...
public class PathGraphUI extends PathGraph {
     ...
     */
    private void newEdge(char param) {
     ...
     * Calls the {@link #newEdge(char)} method with the parameter.
     */
    private final BiConsumer<MouseEvent, Character> lowLevelNewEdge = (event, param) -> newEdge(param);
